...
import com.braintreepayments.api.utilities.TestConfigurationBuilder;
import com.braintreepayments.api.utilities.TestConfigurationBuilder.TestGooglePaymentConfigurationBuilder;
...
import static com.braintreepayments.api.utilities.FixturesHelper.stringFromFixture;
...
import static com.braintreepayments.api.utilities.TestTokenizationKey.TOKENIZATION_KEY;
...
public class GooglePaymentTest {
    ...
    @Rule
    public ActivityTestRule<GooglePaymentActivity> mActivityTestRule =
            new ActivityTestRule(GooglePaymentActivity.class);
